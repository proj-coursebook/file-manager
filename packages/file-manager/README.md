...
A minimal TypeScript package that handles reading files from a source directory and writing (processed) files to a destination directory. More specifically, it handles the following:
...
> [!TIP]
> Refer to this package's docs ([source](../../docs/index.md) or [website](https://proj-coursebook.github.io/file-manager/)) for how to use it.
